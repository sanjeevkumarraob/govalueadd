...
app.directive('locationcomplete', function(){
  var index = -1;
  ...
  return {
    ...
    controller: function($scope, $element, $attrs,$rootScope){
      ...
      $scope.select = function(suggestion){
        $scope.searchParam = suggestion.toLowerCase();
          $rootScope.location = suggestion.toLowerCase();
    ...
    link: function(scope, element, attrs){
     ...
     templateUrl: 'tpl/ac-template.html'
  }
});
...
app.directive('suggestion', function(){
  return {
    restrict: 'A',
    require: '^locationcomplete', // ^look von controller on parents element
...
app.directive('normalautocomplete', function(){
  var index = -1;
  ...
  return {
    ...
    link: function(scope, element, attrs){
     ...
     templateUrl: 'tpl/lc-template.html'
  }
});

app.directive('normalsuggestion', function(){
  return {
    restrict: 'A',
    require: '^normalautocomplete', // ^look von controller on parents element
    link: function(scope, element, attrs, autoCtrl){
      element.bind('mouseenter', function() {
        autoCtrl.preSelect(attrs['val']);
        autoCtrl.setIndex(attrs['index']);
